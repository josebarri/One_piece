...
<template>
  <!-- <nav
    position-static class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600 "
  >
    <div class="max-w-screen-xl flex flex-wrap items-center  justify-between mx-auto p-4">
      <a href="/" class="flex items-center ">
        <img src="https://i.pinimg.com/originals/3f/36/fc/3f36fcdd50dcbfd4a15080c52743a596.png" class="h-11 mr-3" alt="Flowbite Logo" />
